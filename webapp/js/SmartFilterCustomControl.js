sap.ui.define([ 
	...
	return {
        ...
        setSmartFilterModel(oThis) {
            ...
            var me = oThis;
            var oModel = me.getOwnerComponent().getModel("ZVB_3DERP_ANP_FILTERS_CDS");               
            ...
            var oModelURI = new sap.ui.model.odata.v2.ODataModel("/sap/opu/odata/sap/ZVB_3DERP_ANP_FILTERS_CDS");
                        ...
                        oSmartFilter._aFields.forEach(item => {
                            ...
                            if (oFieldAnnotation.length > 0) {
                                ...
                                entityType.property.forEach((prop, index) => {
                                    ...
                                    if (item.name === "MATERIALTYPE" && prop.name === "SBU") {
                                        return;
                                    }
        ...
        onSmartFilterCustomControlValueHelp: function(oEvent) {
            ...
            this._oSmartFilterCustomControlValueHelpDialog = sap.ui.xmlfragment("zuiaprocess.view.fragments.valuehelp.SmartFilterCustomControlValueHelpDialog", this);
